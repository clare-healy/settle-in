# Yin Class Companion — App Spec v2
...
- Palette, texture, and mood drawn from Raw Emerald studio reference photos (pending)
...
1. Studio reference photos → locks the visual design
2. Finalize the class file schema during the build
